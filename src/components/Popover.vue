  ...
  <div class="w-full max-w-sm">
    <Popover v-slot="{ open }" class="relative">
      <PopoverButton
        ...
        class="inline-flex items-center text-base font-medium text-gray-500 hover:text-gray-900 rounded-md group hover:text-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
      >
        <span>Other</span>
        <ChevronDownIcon
          :class="open ? '' : 'text-opacity-70'"
          class="w-5 h-5 ml-2 text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out group-hover:text-opacity-80"
          aria-hidden="true"
        />
      </PopoverButton>
  ...
  setup() {
    return {
      solutions: [
        {
          name: "About us",
          description: "Just a little bit about us",
          href: "/about-us",
          icon: `
            <svg
              width="48"
        ...
        {
          name: "FAQ",
          description: "You might need some help",
          href: "/faq",
          icon: `
            <svg
              width="48"
