  ...
  <div class="min-w-screen flex items-center justify-center px-5 py-5">
    ...
    >
      <div class="md:flex w-full">
        <div class="hidden md:block w-1/2 bg-gray-50 py-10 px-10">
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                ...
                <div class="flex">
                  ...
                  >
                    <MailIcon class="h-5 w-5 text-gray"></MailIcon>
                  </div>
                  <input
                    type="email"
              ...
              <div class="w-full px-3 mb-12">
                ...
                <div class="flex">
                  <div
                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"
                  >
                    <LockClosedIcon class="h-5 w-5 text-gray"></LockClosedIcon>
                  </div>
                  <input
                    type="password"
                    class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
        ...
        <div class="w-full md:w-1/2 py-10 px-5 md:px-10 bg-indigo-500">
